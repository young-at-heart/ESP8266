...
if (strcmp(topic, "inTopic/esp2/gpio5") == 0) {
...
if (strcmp(topic, "inTopic/esp2/gpio4") == 0) {
...
client.publish("outTopic/esp2", "Hello !!!");
// And resubscribe
client.subscribe("inTopic/esp2/gpio5");
client.subscribe("inTopic/esp2/gpio4");
} else {
...
client.publish("outTopic/esp2/temp", msg1);
client.publish("outTopic/esp2/humid", msg2);
}
