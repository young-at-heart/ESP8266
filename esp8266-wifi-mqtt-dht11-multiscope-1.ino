...
if (strcmp(topic, "inTopic/esp1/gpio5") == 0) {
...
if (strcmp(topic, "inTopic/esp1/gpio4") == 0) {
...
client.publish("outTopic/esp1", "Hello !!!");
// And resubscribe
client.subscribe("inTopic/esp1/gpio5");
client.subscribe("inTopic/esp1/gpio4");
} else {
...
client.publish("outTopic/esp1/temp", msg1);
client.publish("outTopic/esp1/humid", msg2);
}
